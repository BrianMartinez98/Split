NAME = libft.a
SOURCE = ft_bzero.c ft_atoi.c ft_isalnum.c ft_isascii.c ft_isdigit.c ft_isprint.c ft_memchr.c ft_memcmp.c ft_memcpy.c \
...
BSOURCE = ft_lstadd_back.c ft_lstclear.c ft_lstdelone.c ft_lstiter.c ft_lstmap.c ft_lstnew.c ft_lstsize.c ft_lstadd_front.c 
C = gcc
OBJ = $(SOURCE:.c=.o)
BOBJ = $(BSOURCE:.c=.o)
